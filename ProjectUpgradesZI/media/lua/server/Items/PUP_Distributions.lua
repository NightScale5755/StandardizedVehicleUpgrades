...
if getActivatedMods():contains("ProjectUpgradesP") then

	SuburbsDistributions.all.Outfit_Mechanic = SuburbsDistributions.all.Outfit_Mechanic or {rolls = 1,items = {},junk= {rolls =1, items={}}}
	table.insert(SuburbsDistributions["all"]["Outfit_Mechanic"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_MetalWorker"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_ConstructionWorker"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Redneck"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_PrivateMilitia"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Raider"].items, "Autotsar.ATAPetyarbuiltTuningMag")
	...
	table.insert(SuburbsDistributions["all"]["Outfit_Survivalist"].items, "Autotsar.ATAPetyarbuiltTuningMag")
